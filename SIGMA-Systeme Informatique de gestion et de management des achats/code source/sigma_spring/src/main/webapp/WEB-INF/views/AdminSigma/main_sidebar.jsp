  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<%if((request.getAttribute("page_name")=="gestionAdminContenu")
        		|| (request.getAttribute("page_name")=="adminContenuForm")){%>active<% }%>">
          <a href="${sessionScope.baseURL}${userConnected.type}/gestionAdminContenu">
            <i class="fa fa-balance-scale"></i> <span>Gestion Admins Contenu</span>
          </a>
        </li>
        
        <li class="<%if((request.getAttribute("page_name")=="gestionAdminEntite")
        		|| (request.getAttribute("page_name")=="adminEntiteForm")){%>active<% }%>">
          <a href="${sessionScope.baseURL}${userConnected.type}/gestionAdminEntite">
            <i class="fa fa-institution"></i> <span>Gestion Admins Entites</span>
          </a>
        </li>
        ...
        <li class="<%if((request.getAttribute("page_name")=="gestionResponsableAchat")
          ...
          <a href="${sessionScope.baseURL}${userConnected.type}/gestionResponsableAchat">
            <i class="fa fa-shopping-cart"></i> <span>Gestion Responsable Achats</span>
          </a>
        </li>
